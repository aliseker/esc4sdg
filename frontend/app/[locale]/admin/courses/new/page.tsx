...
const defaultModuleForm = (langs: Language[]): ModuleForm => ({
  sortOrder: 0,
  translations: langs.map((l) => ({ languageId: l.id, title: '', description: '' })),
  items: [],
});
  ...
  return (
    <div className="max-w-4xl space-y-6">
      <div className="flex items-center gap-4">
        ...
        <h2 className="text-2xl font-bold text-stone-900">Yeni kurs</h2>
      </div>
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4" onClick={() => setAddItemModuleIdx(null)}>
              <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-6 space-y-4" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    type="button"
                    onClick={() => addItemToModule(addItemModuleIdx, 'Video')}
                    className="flex flex-col items-center gap-2 p-4 rounded-xl border-2 border-stone-200 hover:border-teal-400 hover:bg-teal-50 transition-colors"
                  >
                  ...
                  <button
                    type="button"
                    onClick={() => addItemToModule(addItemModuleIdx, 'Pdf')}
                    className="flex flex-col items-center gap-2 p-4 rounded-xl border-2 border-stone-200 hover:border-amber-400 hover:bg-amber-50 transition-colors"
                  >
                  ...
                  <button
                    type="button"
                    onClick={() => addItemToModule(addItemModuleIdx, 'Text')}
                    className="flex flex-col items-center gap-2 p-4 rounded-xl border-2 border-stone-200 hover:border-stone-400 hover:bg-stone-100 transition-colors"
                  >
                  ...
                  <button
                    type="button"
                    onClick={() => addItemToModule(addItemModuleIdx, 'Quiz')}
                    className="flex flex-col items-center gap-2 p-4 rounded-xl border-2 border-stone-200 hover:border-violet-400 hover:bg-violet-50 transition-colors"
                  >
                    <HelpCircle className="w-10 h-10 text-violet-600" />
                    <span className="font-medium text-stone-800">Test</span>
                  </button>
                </div>
                <button type="button" onClick={() => setAddItemModuleIdx(null)} className="w-full py-2 rounded-xl border border-stone-300 text-stone-600 text-sm">
                  İptal
                </button>
              </div>
            </div>
